...
public class InstallActivity extends Activity {
    ...
    public void download(View view) {
		...
		if (networkInfo != null && networkInfo.isConnected()) {
			try {
				...
				URL requestURL = new URL(getResources().getString(R.string.install_download_url) + "/" + downloadFilename);
    ...
    private String[] getSystemMountInfo() {
    	...
    	for (int i = 0; i < cmd_ret.size(); i++) {
    		...
    		if (s[1].equalsIgnoreCase("on") && s[3].equalsIgnoreCase("type")) { // HTC mode
